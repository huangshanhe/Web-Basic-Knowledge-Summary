...
<a href="#1" target="_self">浏览器、HTML、CSS</a>
<a href="#2" target="_self">javascript</a>
<a href="#3" target="_self">稍微难一点</a>
<a href="#4" target="_self">小测验</a>

#  <h3 id="1">浏览器、HTML、CSS</h3>  #
...
# <h3 id="4">常问的其他问题，读者自己尝试总结下答案</h3> #
